            ...
            if (!err) {
                body.rows.map(row => {
                    if (
                        ...
                        if (commentId !== null && commentId !== undefined && commentId.length > 1) {
                            if(process != null && (process === 'delete' || process === 'update')){
            ...
            if (!err) {
                body.rows.map(row => {
                    if (
                        ...
                        if (reviewId !== null && reviewId !== undefined && reviewId.length > 1) {
                            if(process != null && (process === 'delete' || process === 'update')){
